...
1. **CaraCore PDV Desktop (Java · Quarkus)** — Oferta madura multi-plataforma (Windows · Linux · macOS): venda no navegador, operação local; PIX integrado e fiscal no Premium (canal **v3.2.5-free**; Java 25+)
