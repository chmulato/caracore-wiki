...
1. **CaraCore PDV Desktop (Java · JavaFX)** — Oferta madura multi-plataforma (Windows · Linux · macOS): PIX, operação local e conformidade fiscal (canal **v3.2.3-free**; Java 25+)
