...
2. **CaraCore PDV (Rust + Tauri 2)** — Linha desktop piloto Windows, instaladores pt-BR, release **v0.1.3**; download na loja pdv-rust.caracore.com.br (artefatos no GitHub, tag v0.1.3); coexiste com o PDV Desktop Java (não substitui)
